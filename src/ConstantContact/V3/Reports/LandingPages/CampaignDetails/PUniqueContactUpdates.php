...
class PUniqueContactUpdates extends \PHPFUI\ConstantContact\Base
	...
	public function getReturnSchema(string $campaign_activity_id, ?string $limit = null, ?string $contacts_filter = null) : \PHPFUI\ConstantContact\Definition\PContactUpdateTrackingActivitiesPage
		{
