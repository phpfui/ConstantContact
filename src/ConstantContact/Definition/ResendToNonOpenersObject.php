 ...
 * @var \PHPFUI\ConstantContact\DateTime $resend_date The system generated ISO-8601 format date and time that Constant Contact resent the email to non-openers.
