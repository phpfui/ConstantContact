 ...
 * @var \PHPFUI\ConstantContact\DateTime $created_at Date and time that the email_address was created, in ISO-8601 format. System generated.
 * @var \PHPFUI\ConstantContact\DateTime $updated_at Date and time that the email_address was last updated, in ISO-8601 format. System generated.
 * @var \PHPFUI\ConstantContact\DateTime $opt_in_date Date and time that the email_address was opted-in to receive email from the account, in ISO-8601 format. System generated.
 ...
 * @var \PHPFUI\ConstantContact\DateTime $opt_out_date Date and time that the contact unsubscribed/opted-out of receiving email from the account, in ISO-8601 format. Displayed only if contact has been unsubscribed/opt-out. System generated.
