 ...
 * @property string $phone The phone number for the contact.
 * @property string $street Line one of the street address for the contact.
 * @property string $street2 Line two of the street address for the contact. This value is automatically appended to the <code>street</code> value.
 ...
 * @property string $zip The zip or postal code of the contact.
